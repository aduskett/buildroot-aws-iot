...
#
################################################################################
ifeq ($(BR2_AMAZON_CORRETTO_BIN_VERSION_18),y)
AMAZON_CORRETTO_BIN_VERSION = 18.0.1.10.1
else ifeq ($(BR2_AMAZON_CORRETTO_BIN_VERSION_17),y)
AMAZON_CORRETTO_BIN_VERSION = 17.0.3.6.1
else ifeq ($(BR2_AMAZON_CORRETTO_BIN_VERSION_11),y)
AMAZON_CORRETTO_BIN_VERSION = 11.0.15.9.1
else
AMAZON_CORRETTO_BIN_VERSION = 8.332.08.1
endif
