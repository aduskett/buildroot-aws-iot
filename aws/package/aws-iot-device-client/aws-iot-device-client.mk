...
AWS_IOT_DEVICE_CLIENT_VERSION = 1.6
...
ifeq ($(BR2_PACKAGE_AWS_IOT_DEVICE_CLIENT_SENSOR_PUBLISH),y)
AWS_IOT_DEVICE_CLIENT_CONF_OPTS += -DEXCLUDE_SENSOR_PUBLISH=OFF
else
AWS_IOT_DEVICE_CLIENT_CONF_OPTS += -DEXCLUDE_SENSOR_PUBLISH=ON
endif
